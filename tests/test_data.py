...
#         e = get_mocked_etl("save_as_artifact", "generate_data", "validate_data")
#         e.run_task()
...
#         e = get_mocked_etl("save_as_artifact", "generate_data")
#         e.run_task()
#         e.save_as_artifact.assert_called_with(e.generate_data.return_value)
#
...
#         e = get_mocked_etl("save_as_artifact", "validate_data")
#         e.validate_data.side_effect = InvalidDataError
#
#         with pytest.raises(InvalidDataError):
#             e.run_task()
#
#         e.save_as_artifact.assert_not_called()
